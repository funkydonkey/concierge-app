...
Вход: "Добавь к заметке про экипировку для яхтинга новый пункт - легкие шорты"
Действие 1: list_notes(search_query="экипировка для яхтинга")
Комментарий: Не указываем folder, чтобы найти заметку в любой папке (Ideas, Work, Personal, Voice Notes)
Результат: "- Ideas/2026-02-05-Экипировка для яхтинга.md"
Действие 2: read_note(note_path="Ideas/2026-02-05-Экипировка для яхтинга.md")
